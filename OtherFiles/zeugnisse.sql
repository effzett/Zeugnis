CREATE TABLE "ZEUGNISSE".ZEUGNIS
(
		ID_ZEUGNISS INTEGER not null primary key,
		ID_SCHUELER INTEGER,
...
CREATE TABLE "ZEUGNISSE".SCHUELER
(
...
CREATE TABLE "ZEUGNISSE".KRITERIUMSLISTE
(
		ID_KRITERIUMSLISTE INTEGER,
...
CREATE TABLE "ZEUGNISSE".KRITERIUM
(
...
CREATE TABLE "ZEUGNISSE".LERNBEREICH
(
