...
Wenn eine Bewertung vorgenommen wurde, kann diese Bewertung auch wieder als \emph{undefiniert}
 gesetzt werden. Dazu klickt man entweder in der Listbox auf einen leeren Eintrag wie in Abbildung~\ref{fig:Leer1} gezeigt oder genau auf den oberen Strich in der Listbox wie in Abbildung~\ref{fig:Leer2} gezeigt.

\begin{figure}[H]
\centering
\centerline{\includegraphics[width=1.0\textwidth]{Leer1.png}}
\caption{Bewertung auf \emph{undefiniert} setzen (Arbeits-- und Sozialverhalten)}
\label{fig:Leer1}
\end{figure}

\begin{figure}[H]
\centering
\centerline{\includegraphics[width=1.0\textwidth]{Leer2.png}}
\caption{Bewertung auf \emph{undefiniert} setzen (andere Lernbereiche)}
\label{fig:Leer2}
\end{figure}
...
Ist zu \emph{jedem} Indikator aller Lernbereiche eine Bewertung erfolgt (Bewertungsfeld ist nicht leer) erscheint ein Häkchen neben dem Schülernamen, der anzeigt, dass das Zeugnis nun komplett ist und gedruckt werden kann.
...
Hier folgt ein Beispielausdruck der Zeugnisses (1. und 4. Jahrgang), das vollständig ausgefüllt wurde.

\includepdf[pages=-]{ArtmannArnold02012011.pdf}
\includepdf[pages=-]{BeckerBoris02112017.pdf}
