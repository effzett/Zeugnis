...
//            {"Manson", "Charles", "1934-11-12", "Cinncinnati", "1a", "2016"},
            {"Mick", "Jagger", "1943-01-04", "East Hill, Dartford", "1a", "2017"},};
        Integer idZeugnis1;
        Integer idZeugnis2;
        ...
        for (String[] schueler : testClass) {
            ...
            if (idSchueler > 0) {
                ...
                zeugnis1 = new String[]{String.valueOf(idZeugnis1), String.valueOf(idSchueler), "1", "2", "3", "4", "Keine", "Versetzt", "1", "2017","",""};
                zeugnis2 = new String[]{String.valueOf(idZeugnis2), String.valueOf(idSchueler), "1", "2", "3", "4", "Keine", "Versetzt", "2", "2017","",""};
                try {
